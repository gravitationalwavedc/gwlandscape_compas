...
class TestGetLogAndLimits(TestCase):
    def test_min_below_zero(self):
        ...
        returned_array, log_check, min_max, null_check = get_log_and_limits(test_array, False)
    ...
    def test_uniform_array_inside_bounds(self):
        ...
        returned_array, log_check, min_max, null_check = get_log_and_limits(test_array, False, max_cond=15, min_cond=5)
        self.assertSequenceEqual(test_array.tolist(), returned_array.tolist())
        self.assertFalse(log_check)
    ...
    def test_uniform_array_outside_bounds(self):
        test_array = np.array([10, 10, 10])
        returned_array, log_check, min_max, null_check = get_log_and_limits(test_array, False, max_cond=7.5, min_cond=5)
        ...
        returned_array, log_check, min_max, null_check = get_log_and_limits(test_array, False, max_cond=15, min_cond=12.5)
        self.assertSequenceEqual(np.log10(test_array).tolist(), returned_array.tolist())
        self.assertTrue(log_check)
        self.assertCountEqual(min_max, [0.99, 1.01])
        self.assertFalse(null_check)
    ...
    def test_array_inside_bounds(self):
        ...
        returned_array, log_check, min_max, null_check = get_log_and_limits(test_array, False, max_cond=500, min_cond=5)
        self.assertSequenceEqual(test_array.tolist(), returned_array.tolist())
        self.assertFalse(log_check)
    ...
    def test_array_outside_bounds(self):
        test_array = np.array([10, 50, 100])
        returned_array, log_check, min_max, null_check = get_log_and_limits(test_array, False, max_cond=50, min_cond=5)
        self.assertSequenceEqual(np.log10(test_array).tolist(), returned_array.tolist())
        self.assertTrue(log_check)
        ...
        test_array = np.array([10, 50, 100])
        returned_array, log_check, min_max, null_check = get_log_and_limits(test_array, False, max_cond=500, min_cond=400)
        self.assertSequenceEqual(np.log10(test_array).tolist(), returned_array.tolist())
        self.assertTrue(log_check)
        self.assertCountEqual(min_max, [1, 2])
        self.assertFalse(null_check)
    ...
    def test_boolean(self):
        ...
        returned_array, log_check, min_max, null_check = get_log_and_limits(test_array, True)
        self.assertSequenceEqual(test_array.tolist(), returned_array.tolist())
        self.assertFalse(log_check)
