    ...
    const handleJobSubmission = (values) => {
        ...
        commitMutation(environment, {
            ...
            onCompleted: (response, errors) => {
                if (!errors) {
                    router.replace(`/job-results/${response.newCompasJob.result.jobId}/`);
                } else {
            ...
            <Container>
                <Row>
                    <Container>
                        <Row>
                            <Col>
                                <h1 className="pt-5 mb-4">Launch COMPAS Job</h1>
                            </Col>
                        </Row>
                        {outputError && (
                            <Row>
                        ...
                        <Row>
                            <Col md={4}>
                                <Nav variant="pills" className="flex-column">
                                    <Nav.Item>
                                        <Nav.Link eventKey="initialParameters" className="mb-1">
                                            Basic
                                        </Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="supernovaKickParameters" className="mb-1">
                                            Supernova - Kick
                                        </Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="massTransferCEParameters" className="mb-1">
                                            Mass Transfer - CE
                                        </Nav.Link>
                                    </Nav.Item>
                                </Nav>
