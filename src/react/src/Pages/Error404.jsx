            ...
            <Col md={8} lg={6}>
                ...
                <div className="mb-4">
                    ...
                    <div className="d-flex flex-wrap justify-content-center gap-2">
                        <Link as={Button} variant="primary" to="/" exact match={match} router={router} className="m-1">
                            Home
                        </Link>
                        <Link
                            as={Button}
                ...
                <div className="text-muted">
                    <small>If you believe this is an error, please check the URL or contact support.</small>
                </div>
            </Col>
        </Row>
    </Container>
