...
COMMON_ENVELOPE_LAMBDA_PRESCRIPTION_CHOICES = [
    (
        ...
        COMMON_ENVELOPE_LAMBDA_PRESCRIPTION_FIXED,
    ),
    (
        COMMON_ENVELOPE_LAMBDA_PRESCRIPTION_KRUCKOW_VALUE,
        COMMON_ENVELOPE_LAMBDA_PRESCRIPTION_KRUCKOW,
    ),
    (
        COMMON_ENVELOPE_LAMBDA_PRESCRIPTION_LOVERIDGE_VALUE,
        COMMON_ENVELOPE_LAMBDA_PRESCRIPTION_LOVERIDGE,
    ),
    (
        COMMON_ENVELOPE_LAMBDA_PRESCRIPTION_NANJING_VALUE,
        COMMON_ENVELOPE_LAMBDA_PRESCRIPTION_NANJING,
    ),
    (
        COMMON_ENVELOPE_LAMBDA_PRESCRIPTION_DEWI_VALUE,
        COMMON_ENVELOPE_LAMBDA_PRESCRIPTION_DEWI,
    ),
]
##########################
# Supernova
...
REMNANT_MASS_PRESCRIPTION_CHOICES = [
    ...
    (
        REMNANT_MASS_PRESCRIPTION_BELCZYNSKI2002_VALUE,
        REMNANT_MASS_PRESCRIPTION_BELCZYNSKI2002,
    ),
    ...
    (
        REMNANT_MASS_PRESCRIPTION_MULLERMANDEL_VALUE,
        REMNANT_MASS_PRESCRIPTION_MULLERMANDEL,
    ),
]
...
KICK_VELOCITY_DISTRIBUTION_CHOICES = [
    ...
    (
        KICK_VELOCITY_DISTRIBUTION_MAXWELLIAN_VALUE,
        KICK_VELOCITY_DISTRIBUTION_MAXWELLIAN,
    ),
    (
        KICK_VELOCITY_DISTRIBUTION_BRAYELDRIDGE_VALUE,
        KICK_VELOCITY_DISTRIBUTION_BRAYELDRIDGE,
    ),
    (
        KICK_VELOCITY_DISTRIBUTION_MULLER2016_VALUE,
        KICK_VELOCITY_DISTRIBUTION_MULLER2016,
    ),
    (
        KICK_VELOCITY_DISTRIBUTION_MULLER2016MAXWELLIAN_VALUE,
        KICK_VELOCITY_DISTRIBUTION_MULLER2016MAXWELLIAN,
    ),
    (
        KICK_VELOCITY_DISTRIBUTION_MULLERMANDEL_VALUE,
        KICK_VELOCITY_DISTRIBUTION_MULLERMANDEL,
    ),
]
...
PULSATIONAL_PAIR_INSTABILITY_SUPERNOVAE_LABEL = (
    "Pulsational Pair Instability Supernovae"
)
PPI_LOWER_LIMIT_LABEL = "PPI_lower_limit"
PPI_UPPER_LIMIT_LABEL = "PPI_upper_limit"

PULSATIONAL_PAIR_INSTABILITY_PRESCRIPTION_LABEL = (
...
PULSATIONAL_PAIR_INSTABILITY_PRESCRIPTION_CHOICES = [
    (
        PULSATIONAL_PAIR_INSTABILITY_PRESCRIPTION_COMPAS_VALUE,
        PULSATIONAL_PAIR_INSTABILITY_PRESCRIPTION_COMPAS,
    ),
    (
        PULSATIONAL_PAIR_INSTABILITY_PRESCRIPTION_STARTRACK_VALUE,
        PULSATIONAL_PAIR_INSTABILITY_PRESCRIPTION_STARTRACK,
    ),
    (
        PULSATIONAL_PAIR_INSTABILITY_PRESCRIPTION_MARCHANT_VALUE,
        PULSATIONAL_PAIR_INSTABILITY_PRESCRIPTION_MARCHANT,
    ),
]
...
# Mass Transfer
##########################
MASS_TRANSFER_ANGULAR_MOMENTUM_LOSS_PRESCRIPTION_LABEL = (
...
MASS_TRANSFER_ACCRETION_EFFICIENCY_PRESCRIPTION_LABEL = (
    "mass-transfer-accretion-efficieny-prescription"
)
...
NAME_VALUES.update(
    {
        ...
        MASS_TRANSFER_ACCRETION_EFFICIENCY_PRESCRIPTION_THERMAL: MASS_TRANSFER_ACCRETION_EFFICIENCY_PRESCRIPTION_THERMAL_VALUE,
        MASS_TRANSFER_ACCRETION_EFFICIENCY_PRESCRIPTION_FIXED: MASS_TRANSFER_ACCRETION_EFFICIENCY_PRESCRIPTION_FIXED_VALUE,
    }
)
