...
class Event(object):
    ...
    def getEventDetails(self, **kwargs):
        ...
        if eventClass == 'Beg':
            ...
            status = '. Orbit becomes unbound' if (
                        Data['Eccentricity'][ii] > 1 or Data['SemiMajorAxis'][ii] < 0) else ''
            ...
            if state == 'DCO':
                ...
                eventString = r'Double compact object ({}+{}) merging in {:.1f} Myr'.format(self.stypeName1,
